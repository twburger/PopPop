...
public class BitmapObjectCollision {
    /**
     ...
     *
     *  Determine the intersection of two bitmap areas and if common pixel locations are not transparent
     */
